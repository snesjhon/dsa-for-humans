...
export default function JourneyNav({ activeProblemId, activeFundamentalsSlug }: JourneyNavProps) {
  ...
  return (
    <div className="space-y-3 pr-1">
      <p className="text-xs font-semibold uppercase tracking-wider" style={{ color: 'var(--fg-gutter)' }}>
        Your Path
      </p>
          ...
          <div key={section.id}>
            ...
            {isNewPhase && (
              <div className="flex items-center gap-1.5 mb-1.5" style={{ marginTop: idx === 0 ? 0 : 8 }}>
                ...
                <p className="text-xs font-semibold" style={{ color: 'var(--fg-alt)' }}>
            ...
            >
              ...
              >
                ...
                {section.fundamentalsSlug && (
                  <Link
                    ...
                    className="inline-flex items-center gap-1 mt-1.5 transition-opacity hover:opacity-80"
                    style={{
                      fontSize: '0.68rem', fontWeight: 600,
                      color: isCurrentSection ? color : 'var(--fg-gutter)',
                      textDecoration: 'none',
                    }}
                  >
                    <span>📖</span>
              ...
              {hasFirstPass && (
                <div className="px-3 pt-2 pb-1.5" style={{ borderTop: '1px solid var(--border)', background: 'var(--bg)' }}>
                  <p style={{
                    fontFamily: 'ui-monospace, monospace',
                    fontSize: '0.58rem', fontWeight: 700,
                    letterSpacing: '0.09em', textTransform: 'uppercase' as const,
                    color: 'var(--fg-gutter)', marginBottom: 4,
                  }}>
                    Practice
                  </p>

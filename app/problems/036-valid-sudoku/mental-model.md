...
Tracing the first row `["5","3",".",".","7",".",".",".","."]`:

- **(0,0) "5"**, clusterId=0: all three logbooks empty — stamp "5" into rowLogs[0], colLogs[0], clusterLogs[0]
- **(0,1) "3"**, clusterId=0: rowLogs[0] has {"5"}, colLogs[1] empty, clusterLogs[0] has {"5"} — no "3" anywhere, stamp all three
- **(0,2) and (0,3)**: empty cells — skip
- **(0,4) "7"**, clusterId=1: rowLogs[0] has {"5","3"}, colLogs[4] empty, clusterLogs[1] empty — stamp all three
- **(1,0) "5"** (illegal board): rowLogs[0] has {"5","3","7"} — `rowLogs[0].has("5")` fires immediately → return false ✓

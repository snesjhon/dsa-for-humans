...
**Practice** *(do these now — get the basics, build confidence)*:
...
**Revisit** *(return to after Hash Maps — these use concepts from the next step)*:
...
**Revisit** *(return to after Two Pointers)*:

- [x] [49. Group Anagrams](https://leetcode.com/problems/group-anagrams/)
- [ ] [128. Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/)
- [x] [36. Valid Sudoku](https://leetcode.com/problems/valid-sudoku/) *(combines 2D arrays + hash sets — do this one here, not in the Arrays step)*
...
**Revisit** *(return to after Sliding Window)*:
...
**Revisit** *(return to after Linked Lists)*:
...
**Revisit** *(return to after Stack & Queue)*:
...
**Revisit** *(return to after Binary Search — these introduce monotonic stack, a new idea)*:
...
**Practice** *(do these now — in this exact order)*:
...
**Revisit** *(return to after Binary Search)*:
...
**Practice** *(do these now — nail the template before varying it)*:
...
**Revisit** *(return to after Binary Trees — ordered by concept jump)*:
...
**Practice** *(do these now — DFS on trees before BFS)*:
...
**Revisit** *(return to after BST — ordered: validation → BFS intro → combining subtrees → hard)*:
...
**Practice** *(do these now — learn BST by inserting before validating)*:
...
**Practice** *(do these now — max heap then min heap, then combine)*:
...
**Revisit** *(return to after Graph Fundamentals)*:
...
**Practice** *(do these now — grid-based graphs first, adjacency list second)*:
...
**Revisit** *(return to after Graph DFS)*:
...
**Practice** *(do these now — simple DFS before cycle detection)*:

- [ ] [547. Number of Provinces](https://leetcode.com/problems/number-of-provinces/)
- [ ] [797. All Paths From Source to Target](https://leetcode.com/problems/all-paths-from-source-to-target/)
- [ ] [207. Course Schedule](https://leetcode.com/problems/course-schedule/)

**Revisit** *(return to after Graph BFS)*:
...
**Practice** *(do these now — grid BFS before multi-source)*:
...
**Revisit** *(return to after Advanced Graphs)*:
...
**Practice** *(do these now — topo sort → union find → Dijkstra)*:

- [ ] [210. Course Schedule II](https://leetcode.com/problems/course-schedule-ii/)
- [ ] [684. Redundant Connection](https://leetcode.com/problems/redundant-connection/)
- [ ] [743. Network Delay Time](https://leetcode.com/problems/network-delay-time/)

**Revisit** *(return to after Backtracking)*:
...
**Practice** *(do these now — basic combinations before constrained ones)*:
...
**Practice** *(do these now — Fibonacci-like problems before decision DP)*:

- [ ] [70. Climbing Stairs](https://leetcode.com/problems/climbing-stairs/)
- [ ] [746. Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs/)
- [ ] [198. House Robber](https://leetcode.com/problems/house-robber/)

**Revisit** *(return to after DP 2D — in difficulty order)*:
...
**Practice** *(do these now — grid DP → classic string DP)*:

- [ ] [62. Unique Paths](https://leetcode.com/problems/unique-paths/)
- [ ] [1143. Longest Common Subsequence](https://leetcode.com/problems/longest-common-subsequence/)
- [ ] [518. Coin Change II](https://leetcode.com/problems/coin-change-ii/)

**Revisit** *(return to after Greedy)*:
...
**Practice** *(do these now — Kadane's → reachability greedy)*:

- [ ] [53. Maximum Subarray](https://leetcode.com/problems/maximum-subarray/)
- [ ] [55. Jump Game](https://leetcode.com/problems/jump-game/)
- [ ] [45. Jump Game II](https://leetcode.com/problems/jump-game-ii/)

**Revisit** *(return to after Intervals)*:
...
**Practice** *(do these now — simple overlap check before merging)*:
...
**Revisit** *(return to after Math & Geometry)*:
...
**Practice** *(do these now — simple math before matrix manipulation)*:

- [ ] [66. Plus One](https://leetcode.com/problems/plus-one/)
- [ ] [202. Happy Number](https://leetcode.com/problems/happy-number/)
- [ ] [48. Rotate Image](https://leetcode.com/problems/rotate-image/)

**Revisit** *(return to after Bit Manipulation)*:
...
**Practice** *(do these now — XOR properties first)*:

- [ ] [136. Single Number](https://leetcode.com/problems/single-number/)
- [ ] [191. Number of 1 Bits](https://leetcode.com/problems/number-of-1-bits/)
- [ ] [338. Counting Bits](https://leetcode.com/problems/counting-bits/)

**Revisit** *(return to during final review)*:
